...
Although this model preformed significantly better than both the null and baseline model, it is not a strong model to predict birthweight. Only about 54% of the predicted observations were within 10% of the actual birthweight. Thus, significant improvements can be made to better predict birthweight given the data available. 
